package com.BigData.MapReduce.Demo.EMPTotalSalesMapReduce.combiner;
 ...
 */
public class CombinerWordCountMain {
    public static void main(String[] args) throws Exception {
        // 1.创建一个 job = Mapper + Reduce
        Job job = Job.getInstance(new Configuration());

        // 指定Job 的入口
        job.setJarByClass(CombinerWordCountMain.class);
        ...
        // 设置 任务的 Combiner Combiner是一种特殊的Reducer
        job.setCombinerClass(CombinerWordCountReducer.class);
